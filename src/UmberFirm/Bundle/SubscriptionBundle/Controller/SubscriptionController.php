...
namespace UmberFirm\Bundle\SubscriptionBundle\Controller;
 ...
 *
 * @package UmberFirm\Bundle\SubscriptionBundle\Controller
 *
 * @FOS\RouteResource("subscribe")
 * @FOS\NamePrefix("umberfirm__subscription__")
 */
