 ...
 */
class Version20161018102539 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE store ADD geolocation_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\'');
        ...
        $this->addSql('ALTER TABLE store_social_profile ADD social_profile_enum_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\'');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE geolocation ADD stores_id CHAR(36) DEFAULT NULL COLLATE utf8mb4_unicode_ci COMMENT \'(DC2Type:uuid)\'');
        ...
        $this->addSql('ALTER TABLE social_profile_enum ADD store_social_profiles_id CHAR(36) DEFAULT NULL COLLATE utf8mb4_unicode_ci COMMENT \'(DC2Type:uuid)\'');
